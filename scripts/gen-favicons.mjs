...
await renderAt(180).png({ compressionLevel: 9 }).toFile(fileURLToPath(new URL('apple-touch-icon.png', PUBLIC)));
await renderAt(32).png({ compressionLevel: 9 }).toFile(fileURLToPath(new URL('icon-32.png', PUBLIC)));
